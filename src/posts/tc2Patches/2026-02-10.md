...
* Added items bans to competitive matchmaking while we investigate the current meta
    * Based upon typical bans found in community-run leagues
    * In the future, we plan to only restrict items in high-skill matches and then slowly introduce them as balance progresses over time
