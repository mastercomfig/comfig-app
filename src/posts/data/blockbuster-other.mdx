...
* Fixed Sniper Rifle crosshair not being centered on the screen
* Enabled remember last switched weapon by default
* The default volume is now 15%, and the intro video has been updated with a lower volume. No longer blow out your ears when launching the game!
